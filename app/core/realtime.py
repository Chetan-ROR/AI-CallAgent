...
END_CALL_TOOL: dict[str, Any] = {
    ...
    "name": "end_call",
    "description": (
        "End the current conversation when the customer clearly says they are "
        "busy, asks to be called another time, or clearly wants to hang up."
    ),
    "parameters": {
        "type": "object",
        "properties": {},
...
Speak exactly as you would on a live outbound call. Start speaking first.
When you would hang up the phone, call end_call.
